...
#ifndef ANDROID_GUI_BUFFERQUEUEPRODUCERBF_H
#define ANDROID_GUI_BUFFERQUEUEPRODUCERBF_H
...
class BufferQueueProducerBF : public BnGraphicBufferProducer,
                            private IBinder::DeathRecipient {
public:
    friend class BufferQueueBF; // Needed to access binderDied

    BufferQueueProducerBF(const sp<BufferQueueCoreBF>& core);
    virtual ~BufferQueueProducerBF();
