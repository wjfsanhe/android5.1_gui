...
#ifndef ANDROID_GUI_BUFFERQUEUECONSUMERBF_H
#define ANDROID_GUI_BUFFERQUEUECONSUMERBF_H
...
class BufferQueueCoreBF;

class BufferQueueConsumerBF : public BnGraphicBufferConsumer {

public:
    BufferQueueConsumerBF(const sp<BufferQueueCoreBF>& core);
    virtual ~BufferQueueConsumerBF();
