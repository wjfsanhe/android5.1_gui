...
#ifndef ANDROID_GUI_BUFFERQUEUECOREBF_H
...
class BufferQueueCoreBF : public virtual RefBase {
...
public:
    ...
    // gralloc buffers.
    BufferQueueCoreBF(const sp<IGraphicBufferAlloc>& allocator = NULL);
    virtual ~BufferQueueCoreBF();
